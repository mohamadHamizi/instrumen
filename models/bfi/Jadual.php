 ...
 */
class Jadual extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->FormulaIndeks($this->rItem1, $this->item6);
    }
    public function getExtraversionPurata()
    {
        return $this->FormulaPurata($this->rItem1, $this->item6);
    }
    public function getExtraversionSkor()
    {
        return $this->FormulaSkor($this->rItem1, $this->item6);
    }
    ...
    {
        return $this->FormulaIndeks($this->item2, $this->rItem7);
    }
    public function getAgreeablenessPurata()
    {
        return $this->FormulaPurata($this->item2, $this->rItem7);
    }
    public function getAgreeablenessSkor()
    {
        return $this->FormulaSkor($this->item2, $this->rItem7);
    }
    ...
    {
        return $this->FormulaIndeks($this->rItem3, $this->item8);
    }
    public function getConscientiousnessPurata()
    {
        return $this->FormulaPurata($this->rItem3, $this->item8);
    }
    public function getConscientiousnessSkor()
    {
        return $this->FormulaSkor($this->rItem3, $this->item8);
    }
    ...
    {
        return $this->FormulaIndeks($this->rItem5, $this->item10);
    }
    public function getOpennessPurata()
    {
        return $this->FormulaPurata($this->rItem5, $this->item10);
    }
    public function getOpennessSkor()
    {
        return $this->FormulaSkor($this->rItem5, $this->item10);
    }
    ...
    public function getRItem1()
    {
        return $this->reverseSkor($this->item1);
    }
    public function getRItem3()
    {
        return $this->reverseSkor($this->item3);
    }
    public function getRItem4()
    {
        return $this->reverseSkor($this->item4);
    }
    public function getRItem5()
    {
        return $this->reverseSkor($this->item5);
    }
    public function getRItem7()
    {
        return $this->reverseSkor($this->item7);
    }
