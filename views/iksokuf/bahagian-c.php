...
<div class="box box-info">
    ...
    <div class="oku-respons-form">
        ...
        ?>
        <div class="box-body">
            <p><strong>Arahan:</strong> Pernyataan berikut merupakan persetujuan anda mengenai Strategi kebahgaiaan Subjektif OKU-Fizikal. Anda dikehendaki menjawab <strong>SEMUA</strong> pernyataan dengan menandakan pada salah satu respons yang diberikan. </p>
