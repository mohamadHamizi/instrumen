...
<div class="box box-info">
    ...
    <div class="oku-respons-form">
        ...
        ?>
        <div class="box-body">
            <p><strong>Arahan:</strong> Pernyataan berikut merupakan persetujuan anda mengenai Strategi kebahagiaan Subjektif OKU-Fizikal. Anda dikehendaki menjawab <strong>SEMUA</strong> pernyataan dengan menandakan pada salah satu respons yang diberikan. </p>
            <div class="table-responsive">
                ...
                <div class="form-group text-center">
                    <?= Html::a('<i class="fa fa-arrow-left"></i>&nbsp;Back', ['iksokuf/bahagian-b'], ['class' => 'btn btn-success']) ?>
