...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-wheelchair-alt"></i>&nbsp;<strong>Notice and Privacy</strong></h3>
    </div>
    <div class="box-body">
        <p>
...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-wheelchair-alt"></i>&nbsp;<strong>Notis dan Privasi</strong></h3>
    </div>
    <div class="box-body">
        <p>
