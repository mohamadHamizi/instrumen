    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <?= $form->field($model, 'jantina')->radiolist(['L' => 'Male', 'P' => 'Female'])->label(false);
                ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                ...
                <?= $form->field($model, 'status_kerja_lain')->textInput(['hidden' => true, 'id' => 'status_kerja_lain', 'placeholder' => 'State your working status'])->label(false) ?>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <?php echo DatePicker::widget([
                    ...
                    'readonly' => true,
                    'options' => ['placeholder' => 'Day/Month/Year'],
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                ...
                echo $form->field($model, 'darah')->widget(Select2::classname(), [
                    'data' => $jenis_darah,
                    'options' => ['placeholder' => '--Choose Blood Type--'],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ])->label(false);
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                ...
                echo $form->field($model, 'warganegara')->widget(Select2::classname(), [
                    'data' => $warganegara,
                    'options' => ['placeholder' => '--Choose Citizenship--'],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ])->label(false);
...
$('input[name="Demo[status_kerja]"]').on('change', function () {
if ($(this).val() == '99') {
