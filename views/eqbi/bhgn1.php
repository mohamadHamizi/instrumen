...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group text-center">
            <?= Html::a('<i class="fa fa-arrow-left"></i>&nbsp;Previous', ['demografi'], ['class' => 'btn btn-warning']); ?>
            <?= Html::submitButton('Next&nbsp;<i class="fa fa-arrow-right"></i>', ['class' => 'btn btn-primary', 'data' => ['disabled-text' => 'Loading..']]) ?>
        </div>
        <?php ActiveForm::end(); ?>
