...
<div class="box box-info">
    ...
    <div class="box-body">
        ...
        <p>
            <i>The Emotional Quotient Inventory Youth Version</i> (EQ-i:YV) yang direkabentuk oleh Bar-On dan Parker merupakan salah satu instrumen yang digunakan untuk mengukur kecerdasan emosi sosial. EQ-i:YV telah diterbitkan pada tahun 2000 yang mengandungi sebanyak 60 item dengan 6 dimensi utama iaitu intrapersonal, interpersonal, adaptasi, pengurusan tekanan, mood umum dan juga pengaruh positif.
        </p>
        ...
        <ol>
            <li>Penyertaan anda dalam sesi pentadbiran soal selidik EQ-Malay adalah sukarela.</li>
            <li>Anda perlu menjawab semua soalan EQ-Malay dengan jujur dan ikhlas.</li>
            <li>Tidak ada jawapan betul atau salah.</li>
            <li>Ujian ini akan mengambil masa lebih kurang 15-20 minit.</li>
            ...
            <li>Sila tandakan satu pilihan jawapan bagi skala antara 1 hingga 4 pada setiap soalan yang dikemukakan.</li>
