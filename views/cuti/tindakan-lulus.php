...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title"> <i class="fa fa-pencil"></i>&nbsp;<strong>Tindakan Kelulusan</strong></h3>
    </div>
    <?php
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label"><i class="fa fa-pencil-square"></i>&nbsp;Catatan Kelulusan</label>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <?= Html::activeDropDownList($model, 'status', ['APPROVED' => 'DILULUSKAN', 'REJECTED' => 'TIDAK DILULUSKAN']) ?>
            </div>
        </div>
