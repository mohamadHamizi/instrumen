...
<div class="box box-info">
    <div class="box-header with-border">
        <h4 class="box-title"><i class="fa fa-list-ul"></i>&nbsp;<strong>Senarai tindakan untuk Kelulusan</strong></h4>
    </div>
    <div class="box-body">
                ...
                <?php if ($model) { ?>
                    <?php foreach ($model as $cuti) { ?>
                        <tr>
                            ...
                            <td class="text-center"><?= Html::a('<i class="fa fa-pencil"></i>', ['/cuti/tindakan-lulus', 'id'=>$cuti->id], ['class' => 'btn-sm']) ?></td>
