...
use app\models\eq2\Demo;
use app\models\eq2\Main;
use app\models\eq2\Bhgn1;
use app\models\eq2\Bhgn2;
use app\models\eq2\Bhgn3;
use app\models\eq2\Bhgn4;
use app\models\eq2\Bhgn5;
use app\models\eq2\Bhgn6;
...
class Eq2Controller extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                ...
                $session->set('eq2_main_id', $model->id);
    ...
    public function actionDemografi()
    {
        ...
        $id = \Yii::$app->session->get('eq2_main_id');
    ...
    public function actionDes()
    {
        ...
        Yii::$app->session->remove('eq2_main_id');

        Yii::$app->session->destroy(); // destroy all session
        return $this->redirect(['eq2/index']);
    }
